...
#Filtrar apenas cartas que começam com "8_" ou "9_"
cartas_89 = [carta for carta in simulacoes if carta.startswith("8_") or carta.startswith('9_')]

prob = len(cartas_89) / len(simulacoes) 

print(f"Número de cartas 8 ou 9: {len(cartas_89)}")
print(f"Probabilidade de sair 8 ou 9: {prob:.4f}")
